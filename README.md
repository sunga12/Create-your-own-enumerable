...
**Create Your Own Enumerable** is a project written ruby that implements methods of the Enumerable Module on a given
...
```sh
  git clone git@github.com:/sunga12/Create-your-own-enumerable.git
...
If you like this project [give it a star on GitHub!](https://github.com/sunga12/Create-your-own-enumerable)
